...
var requestZipcode = function requestZipcode(zipcode) {
...
var capitalize = function capitalize(city) {
...
var hasChanged = function hasChanged(zipcode) {
  return requestZipcode(zipcode).then(function (data) {
    if (!data) {
      return;
    }
...
Promise.resolve(_.pluck(locations, "zipcode")).each(function (zipcode) {
